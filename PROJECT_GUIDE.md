...
| `assets/workspace-template/asset-generation/write_copy_deepseek.py` | Optional DeepSeek v4 Flash writer for `title`, `body_full`, and `tags`; reads `DEEPSEEK_API_KEY` from workspace `.env` or the environment. |
